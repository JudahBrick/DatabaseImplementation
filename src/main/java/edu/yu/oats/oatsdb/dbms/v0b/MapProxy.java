    ...
    protected int acquireLock(K key) throws ClientTxRolledBackException{
        ...
        try{
            if(locks.containsKey(key)){
                //TODO fix this v0b timeout logic
                if(locks.get(key).tryLock()){
                ...
                logger.info("Tried to get lock couldn't" );
                Thread.sleep(timeoutInMilli);
                logger.info("Tried & slept twice, rolling back");
...
//                    }
//                    else if (i == 2){
//                        //need to rollback and throw the ClientTxRolledBackException
////                        if(locks.get(key).tryLock()){
////                            int numOfHolds = locks.get(key).getHoldCount();
////                            return numOfHolds;
////                        }
...
//                }
        ...
        //TODO learn about InterruptedException and see if this is the right way to deal with this
    ...
    protected void releaseLocks(Set<K> keys) {
       ...
       while(it.hasNext()){
            ...
            logger.info("Number of holds on lock: " + numOfHolds);
