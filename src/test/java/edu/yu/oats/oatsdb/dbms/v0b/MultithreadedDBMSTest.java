...
public class MultithreadedDBMSTest {
    ...
    MultithreadedDBMSTest(){
        myDBMS = edu.yu.oats.oatsdb.dbms.v0b.DBMSImpl.Instance;
        ((DBMSImpl) myDBMS).setTxTimeoutInMillis(200);
        myTxMng = edu.yu.oats.oatsdb.dbms.v0b.TxMgrImpl.Instance;
    }
    ...
    private void vanillaMapsTest(){
        ...
        try {
            ...
            myTxMng.commit();
            myTxMng.begin();
            mapFun = myDBMS.getMap("first test map", String.class, String.class);
            mapFun.put("input after commit", "second input test val");
            isThere2 = mapFun.containsKey("input after commit");
            myTxMng.commit();
